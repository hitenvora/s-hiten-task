...
.btn-success {
    ...
    <div class="intro-y mt-8 flex items-center" style="margin-bottom:13px; margin-top:0px;">
        <h2 class="mr-auto text-lg font-medium" style="font-size:22px;">Update Category</h2>
    </div>
    <div class="mt-5 grid grid-cols-12 gap-6">
        <div class="intro-y col-span-12 lg:col-span-12" style="padding: 20px 32px;border: 1px solid #e1dede;border-radius: 6px;box-shadow: 0 3px 10px rgb(69 14 33 / 20%);background: white;border-top: 7px solid #164e63;">
            <form action='{{ route('update.category.db',["Id"=>$Id]) }}' method="post" enctype="multipart/form-data">
            <div class='grid-cols-12 grid'> 
                ...
                <button class='btn btn-success btn_add_address mt-3' type='submit' style="margin-top: 40px;">Update</button>
                </div>
            </div>
            </form>
        </div>
