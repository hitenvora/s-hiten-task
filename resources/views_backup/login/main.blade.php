...
@section('head')
    <title>Login - SK Enterprise Admin Template</title>
@endsection
...
@section('content')
    <div @class([
        ...
        <div class="container relative z-10 sm:px-10" style="margin-left: 83px;">

            <div class="block grid-cols-2 gap-4 xl:grid">

                <!-- BEGIN: Login Info -->

                <div class="hidden min-h-screen xl:flex">

                    <a class="-intro-x flex items-center pt-5" href="">
                        <img class="w-6" src="{{ asset('login-image.png') }}" alt="Enigma Tailwind HTML Admin Template"
                ...
                <div class="my-10 flex h-screen py-5 xl:my-0 xl:h-auto xl:py-0" style="margin-left: 200px;">
                    ...
                    <div
                        ...
                        <a class="-intro-x  items-center pt-5" href="" >
                            <img
                            class="w-6"
                            src="{{ asset('sk_logo.jpg') }}"
                            alt="Enigma Tailwind HTML Admin Template" style="width: 170px;border-radius: 15px;" />
                            </a>
