                ...
                <div class='grid-cols-12 grid'>
                    ...
                    <div class='col-span-6 mr-5'>
                        <div class="input-form mt-3">
                            ...
                            <input name="user_name" type="text" required="required" class="form-control" />
                        </div>
                    </div>
                    <div class='col-span-6 mr-5'>
                        <div class="input-form mt-3">
                            <label style="font-weight:600; line-height:30px;"> Mobile No </label>
                            <input name="mobile_no" type="text" required="required" maxlength="10" minlength="10" class="form-control" />
                        </div>
                    </div>
                    <div class='col-span-6 mr-5'>
                        <div class="input-form mt-3">
                            <label style="font-weight:600; line-height:30px;"> Aadhar No </label>
                            <input name="aadhar_no" type="text" required="required" class="form-control" />
                        </div>
                    </div>
                    {{-- <div class='col-span-6 mr-5'>
                        <div class="input-form mt-3">
                    ...
                    <div class='col-span-6 mr-5'>
                        <div class="input-form mt-3">
                            <label style="font-weight:600; line-height:30px;"> Password Confirmation </label>
                            <div class="input-group">
                                <input name="password_confirmation" id="password_confirmation" type="password" required="required" class="form-control" />
                                <div class="input-group-append">
                    ...
                    <div class='col-span-6 mr-5'>
                        <div class="input-form mt-3">
                            ...
                            <input name="doj" type="date" required="required" class="form-control" />
                    ...
                    <div class='col-span-6 mr-5'>
                        <div class="input-form mt-3">
                            ...
                            <input name="monthly_salary" type="text" required="required" class="form-control" />
                    ...
                    <div class='col-span-12 mr-5'>
                        <div class="input-form mt-3">
                            ...
                            <input name="address" type="text" required="required" class="form-control" />
