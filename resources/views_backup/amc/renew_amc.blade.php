                ...
                <div class="input-form mt-3">
                    ...
                    <select name="_customer_details_id[]" id="_customer_details_id" class='form-control select' multiple>
                        @foreach ($GetCustomerDetail as $addres)
                            <option @selected(in_array($addres->id,$addresids)) value='{{ $addres->id }}'>{{ $addres->location_type }}</option>
                        @endforeach
                    </select>
                </div>
                <div class="input-form mt-3">
                ...
                <div class='grid-cols-12 grid'>
                    <div class='col-span-6'>
                        <div class="input-form mt-3">
                            ...
                            <input name="start_date" type="date" id='start-date' value="{{ date('Y-m-d'); }}" required="required" class="form-control" />
                        </div>
                    </div>
