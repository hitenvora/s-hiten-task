...
<script src="{{asset('js/')}}/html2pdf.bundle.min.js"></script>
    <div class="grid grid-cols-12 gap-6 mt-5">
        ...
        <h2 class="mt-10 text-lg font-medium intro-y">Pending AMC</h2>
         <div class="mx-auto hidden text-slate-500 md:block">
               
        </div>
        <div class="mt-3 w-full sm:mt-0 sm:ml-auto sm:w-auto md:ml-0" style="display: flex;">
                <div class="relative w-56 text-slate-500">
                    <form method="get" action="/search-pending">
                        <x-base.form-input
                ...
                <x-base.table.tbody >
                    ...
                    if(Request::get('search') != '')
                    {
                        ...
                        $amcs = DB::table('amcs')
                                    ...
                                    ->whereDate('amc_visit.visit_date','<', $currentDate)->Where('users.name', 'like', "%{$value}%")->orWhere('amcs.amc_type', 'like', "%{$value}%")->orWhere('amcs.contract_amount', 'like', "%{$value}%")
                    ...
                    @endphp
                        ...
                        <x-base.table.tr class="intro-x ">
                            ...
                            <x-base.table.td  class="w-10 border-b-0 bg-white shadow-[20px_3px_20px_#0000000b] first:rounded-l-md last:rounded-r-md dark:bg-darkmode-600 m-10px" >
                                     <a href="#">
                        ...
                        <a href="{{ route('create.complaint') }}">
                            <button data-tw-merge class="transition duration-200 border shadow-sm inline-flex items-center justify-center py-2 px-3 rounded-md font-medium cursor-pointer focus:ring-4 focus:ring-primary focus:ring-opacity-20 focus-visible:outline-none dark:focus:ring-slate-700 dark:focus:ring-opacity-50 hover:bg-warning hover:border-warning text-slate-900 dark:border-warning dark:text-slate-300 dark:hover:bg-darkmode-800/70 mb-2 mr-1">
                                ...
                                <i data-lucide="edit" width="15" height="15" class="stroke-1.5 h-5 w-8"></i>Create Complaint</button>
