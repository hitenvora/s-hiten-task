...
<script src="{{asset('js/')}}/html2pdf.bundle.min.js"></script>
    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        ...
        <h2 class="mt-10 text-lg font-medium intro-y">End AMC</h2>
    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        ...
        <div class="col-span-12 overflow-auto intro-y 2xl:overflow-visible" id="invoice">
            <x-base.table class="-mt-2 border-separate border-spacing-y-[10px] content-table" id="default-datatable">
                ...
                <x-base.table.tbody >
                    @if (count($getEndData) > 0)      
                        @php $i = 0; @endphp
                        @foreach ($getEndData as $key => $row)
                        @php $i++; @endphp
                            ...
                            <x-base.table.tr class="intro-x ">
                                ...
                                <x-base.table.td  class="w-10 border-b-0 bg-white shadow-[20px_3px_20px_#0000000b] first:rounded-l-md last:rounded-r-md dark:bg-darkmode-600" >
                                    {{ date('d-m-Y', strtotime($row->upcoming_visit)) }}
                                </x-base.table.td>
                    ...
                    @else
                    <x-base.table.tr class="intro-x ">
                        <x-base.table.td  class="w-10 border-b-0 bg-white text-center shadow-[20px_3px_20px_#0000000b] first:rounded-l-md last:rounded-r-md dark:bg-darkmode-600" colspan="5">
                            Record Not Found
                        </x-base.table.td>
                    </x-base.table.tr>
                    @endif
