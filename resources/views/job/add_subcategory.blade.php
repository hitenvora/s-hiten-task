...
@section('subcontent')
    ...
    <div class="intro-y mt-8 flex items-center" style="margin-bottom:13px; margin-top:0px;">
        ...
        <h2 class="mr-auto text-lg font-medium" style="font-size:22px;">Create Subcategory</h2>
    ...
    <div class="mt-5 grid grid-cols-12 gap-6">
        <div class="intro-y col-span-12 lg:col-span-12"
            ...
            <form action="{{ route('add.subcategory.db') }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="grid-cols-12 grid">
                    <div class="col-span-4 mr-5">
                        <div class="input-form mt-3">
                            <label style="font-weight:600; line-height:30px;"> Category <span style="color: red">*</span></label>
                    ...
                    <div class="col-span-4 mr-5">
                        <div class="input-form mt-3">
                            <label style="font-weight:600; line-height:30px;"> Subcategory <span style="color: red">*</span></label>
                            <input type='text' class='form-control' name='subcategory' required>
                        </div>
                    </div>
                    <div class="col-span-4 mr-5">
                        <div class="input-form mt-3">
                            <label style="font-weight:600; line-height:30px;"> Price <span style="color: red">*</span></label>
