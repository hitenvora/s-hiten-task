                    ...
                    @php
                        ...
                        if (Request::get('search') != '') {
                            ...
                            $amcs = DB::table('amcs')
                                ...
                                ->orWhere('amcs.amc_type', 'like', "%{$value}%")
                                ->orWhere('amcs.contract_amount', 'like', "%{$value}%")
                    ...
                    @foreach ($amcs as $row)
                        ...
                        <x-base.table.tr class="intro-x">
                            ...
                            <x-base.table.td
                                ...
                                <a class=" flex" href="{{ route('create.complaint', ['amcvisit_id' => $row->id]) }}">
                ...
                @foreach ($amcs as $row)
                    ...
                    <x-base.table.tr class="intro-x">
                        ...
                        <x-base.table.td
                            ...
                            @foreach ($variableAry as $value)
                                @php
                                    $customerDetailscount = DB::table('customer_details')->where('id', $value)->count();
                                @endphp
                                @if ($customerDetailscount > 0)
                                    @php
