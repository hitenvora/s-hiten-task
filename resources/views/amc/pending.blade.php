                ...
                <x-base.table.tbody>
                    ...
                    @foreach ($amcs as $row)
                        ...
                        <x-base.table.tr class="intro-x ">
                            ...
                            <x-base.table.td
                                class="w-10 border-b-0 bg-white shadow-[20px_3px_20px_#0000000b] first:rounded-l-md last:rounded-r-md dark:bg-darkmode-600 m-10px">
                                {{-- <a href="#">
                                ...
                                <a href="{{ route('create.complaint') }}">
                                    <button data-tw-merge
                                        ...
                                        <i data-lucide="edit" width="15" height="15"
                                            class="stroke-1.5 h-5 w-8"></i>Create Complaint</button>
