            ...
            {{-- <div class="mt-3 w-full sm:mt-0 sm:ml-auto sm:w-auto md:ml-0 flex flex-wrap items-center sm:flex-nowrap">
                ...
                <div class="dropdown">
                    ...
                    <div id="myDropdown" class="dropdown-content">
                        <a><button class="btn btn-warning" id="btnExportExcel" style="padding:0px;">Export
                                Excel</button></a>
                        <a><button class="btn btn-warning" id="btnExportPDF" style="padding:0px;">Export PDF</button></a>
                    </div>
                </div>
            </div> --}}
        </div>
...
@else
                        ...
                        <x-base.table.tr class="intro-x">
                            ...
                            <x-base.table.td
                                ...
                                <form id="deleteForm{{ $data->id }}"
                                    action="{{ route('del.customer', ['id' => $data->id]) }}" method="get">
                                    @csrf
                                    ...
                                    <button data-tw-merge type="submit"
                                        ...
                                        <i data-lucide="trash" width="15" height="15"
                                            class="stroke-1.5 h-5 w-8"></i>Delete
                                    </button>
                                </form>
    ...
    <script>
        ...
        //     TableExport(document.getElementById("exportTable"), {
        //         headers: true,
        //         footers: true,
