                ...
                <div class='grid-cols-12 grid'>
                    <div class='col-span-6 mr-5'>
                        <div class="input-form">
                            ...
                            <input name="name" type="text" value="{{ old('name') }}" required="required"
                                class="form-control" />
                        </div>
                    </div>
                    <div class='col-span-6 mr-5'>
                        <div class="input-form">
                            ...
                            <input name="phone_no" id="phone_no" type="text" value="{{ old('phone_no') }}"
                ...
                <div class='grid-cols-12 grid main_addredd_div'
                    ...
                    <div class='col-span-3 mr-5 mt-3'>
                        <div class="input-form">
                            ...
                            <input name="location_type[0]" type="text" required="required"
                                value="{{ old('location_type.0') }}" class="form-control" placeholder="Home/Office/Other" />
                        </div>
                    </div>
                    <div class='col-span-3 mr-5 mt-3'>
                        <div class="input-form">
                            <label style="font-weight:600; line-height:30px;"> Pincode </label>
                            <input name="pincode[0]" type="text" required="required" value="{{ old('pincode.0') }}"
                                class="form-control" />
                    ...
                    <div class='col-span-6 mt-3'>
                        <div class="input-form">
                            ...
                            <input name="address[0]" type="text" required="required" value="{{ old('address.0') }}"
                                class="form-control" />
                        </div>
                    </div>
                </div>
                    ...
                    <div class="grid-cols-12 grid ">
                        ...
                        <div class='col-span-2 mr-5 mt-3 '>
                            <div class="input-form">
                                ...
                                <input name="no_ac[0][]" type="text" value="{{ old('no_ac.0.0') }}" required="required"
                                    class="form-control no_ac" />
                            </div>
                        </div>
                        <div class='col-span-2 mr-5 mt-3' style="margin-bottom: 15px;">
                            <div class="input-form">
                                <label style="font-weight:600; line-height:30px;"> No of Ton </label>
                                <input name="no_of_ton[0][]" type="text" value="{{ old('no_of_ton.0.0') }}"
                                    required="required" class="form-control no_of_ton" />
                        ...
                        <div class='col-span-1 mr-5 mt-3' style="margin-bottom: 15px;">
                            <div class="input-form">
                                ...
                                <input name="total_ac_ton[0][]" type="text" value="{{ old('total_ac_ton.0.0') }}"
                                    required="required" class="form-control total_ac_ton" />
                            </div>
                        </div>
                        <div class='col-span-3 mr-5 mt-3' style="margin-bottom: 15px;">
                            <div class="input-form">
                                <label style="font-weight:600; line-height:30px;"> Message </label>
                                <input name="message[0][]" type="text" value="{{ old('message.0.0') }}"
                                    required="required" class="form-control message" />
                            </div>
                        </div>
                        ...
                        <div class='col-span-12'>
                            <div id="search_container" style="margin-bottom: 0.75rem;"><input id="search_location"
                                    type="text" placeholder="Search Location" class="pac-target-input"
        ...
        <script>
            ...
            $('body').on('click', '.btn_add_address', function() {
                ...
                $('.add_other_address').append(
                    ...
                    '<label style="font-weight:600; line-height:30px;">Total Ton</label>' +
                    // '<input type="text" class="form-control total_ton"   readonly>'  +
                    '<input type="text" class="form-control total_ton" id="total_ton_' + typeIndex + '" readonly>' +

                    // '<input type="text" class="form-control total" id="total_' + typeIndex + '" readonly>' +
                    '</div>' +
                    '</div>' +
                    '<div class="add_other_ac col-span-12"></div>' +
                    '<div class="col-span-12 mr-5 mt-3 mb-3">' +
                    '<div id="search_container_' + mapId +
                    '" style="text-align: right; margin-bottom: 1px;"></div>' +
                    '</div>' +
                    // '<div class="add_other_ac col-span-12"></div>' +
                    '<div class="col-span-12">' +
                ...
                var subtotalByTypeIndex = {};

                function calculateSubtotal(typeIndex) {
                    var total_ac_ton = 0;
                    $('input[name="total_ac_ton[' + typeIndex + '][]"]').each(function() {
                        var value = parseFloat($(this).val()) || 0;
                        total_ac_ton += value;
                    });
                    subtotalByTypeIndex[typeIndex] = total_ac_ton; // Store subtotal for this typeIndex
                    return total_ac_ton;
                }



                var subtotal = calculateSubtotal(typeIndex);
                // console.log("Subtotal for typeIndex " + typeIndex + ":", subtotal);

                // console.log("Subtotal for typeIndex " + typeIndex + ": " + $('input[name="total_ac_ton[' + typeIndex +
                //     '][]"]').val());

                // console.log("Selector: " + 'input[name="total_ac_ton[' + typeIndex + '][]"]');
                // console.log("Number of elements found: " + $('input[name="total_ac_ton[' + typeIndex + '][]"]').length);
                // console.log("Subtotal for typeIndex " + typeIndex + ": " + $('input[name="total_ac_ton[' + typeIndex +
                //     '][]"]').val());
            ...
            // Calculate and update the total whenever the value of total_ac_ton fields change
            // $('body').on('input', 'input[name^="add_total_ac_ton[' + typeIndex + '][]"]', function() {
            //     var total = 0;

            //     $('input[name^="add_total_ac_ton[' + typeIndex + '][]"]').each(function() {
            ...
            //     });
            //     $('#total_' + typeIndex).val(total); // Adjust decimal places as needed
            // });
            ...
            script.src =
                'https://maps.googleapis.com/maps/api/js?key=AIzaSyCBc-IV1LhwxzZkVbGfqiHKq-wiHayqgU8&libraries=places&callback=initMap';
            script.defer = true;
            ...
            $(document).ready(function() {
                $('body').on('click', '.btn_add_ac', function() {
                    ...
                    $(this).closest('.grid-cols-12').find('.add_other_ac').append(
                        ...
                        val +
                        '][]" type="text" required="required" class="form-control no_ac" /></div></div>' +
                ...
                $('body').on('input', '.no_of_ton, .no_ac', function() {
                    ...
                    var no_of_ton_val = parseFloat($grid.find('.no_of_ton').val());
