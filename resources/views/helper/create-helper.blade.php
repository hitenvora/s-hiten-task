                ...
                <div class='grid-cols-12 grid'>
                    ...
                    <div class='col-span-6 mr-5'>
                        <div class="input-form mt-3">
                            ...
                            <input name="mobile_number" type="text" maxlength="10" minlength="10" class="form-control"
                    ...
                    <div class='col-span-6 mr-5'>
                        <div class="input-form mt-3">
                            ...
                            <input name="aadhar_no" type="text" class="form-control" value="{{ old('aadhar_no') }}" />
                            @error('aadhar_no')
                                <div class="alert alert-danger error">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class='col-span-6 mr-5'>
                        <div class="input-form mt-3">
                            ...
                            <input name="doj" type="date" class="form-control"  value="{{ old('doj') }}" />
                            @error('doj')
                                <div class="alert alert-danger error">{{ $message }}</div>
                            @enderror
                        </div>
