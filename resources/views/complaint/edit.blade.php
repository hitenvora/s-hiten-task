                ...
                <div class='grid-cols-12 grid'>
                    ...
                    <div class='col-span-6 mr-5'>
                        <div class="input-form mt-3">
                            ...
                            <input type="text" id="amc_type" name="amc_type" value="{{ $complaint->amc_type }}"
                    ...
                    <div class="col-span-6 mt-3">
                        ...
                        <select class='form-control ' name='payment_type'>
                            ...
                            <option value='Card' {{ $complaint->payment_type == 'Card' ? 'selected' : '' }}>Pending
                            </option>
                        ...
                        <select class='form-control ' name='job_category'>
                            ...
                            @foreach ($getCategory as $cat)
                                <option value="{{ $cat->category }}"
                                    {{ $complaint->job_category == $cat->category ? 'selected' : '' }}>
                                    {{ $cat->category }}</option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div class="col-span-6 mt-3 mr-5">
                        ...
                        <input name="contact_p_name" type="text" placeholder="Contact Person Name" class="form-control"
                            value="{{ $complaint->contact_p_name }}" />
                    </div>
                    <div class="col-span-6 mt-3 mr-5">
                        ...
                        <input name="contact_p_mobile_no" type="text" placeholder="Contact Person Mobile No"
                            ...
                            value="{{ $complaint->contact_p_mobile_no }}" />
                    </div>
                    <!--<div class="input-form mt-3">-->
                        ...
                        <select class='form-control  @error('supervisor_id') is-invalid @enderror' name='supervisor_id'
                            ...
                            @foreach ($getSupervisor as $supervisor)
                                <option value="{{ $supervisor->id }}"
                                    {{ $supervisor->id == $complaint->supervisor_id ? 'selected' : '' }}>
                                    {{ $supervisor->supervisor_name }}</option>
                            @endforeach
                        </select>
                        @error('supervisor_id')
                            <div class="alert alert-danger error">Supervisor field is Required</div>
                        @enderror
                    </div>
                    <div class='col-span-6 mr-5'>
                        <div class="input-form mt-3">
                            ...
                            <img id="imagePreview"
                                src="{{ $complaint->image ? asset('complaint_image/' . $complaint->image) : '' }}"
