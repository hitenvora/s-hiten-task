...
@section('subcontent')
    ...
    <div class="grid grid-cols-12 gap-6">
        <div class="intro-y col-span-12 lg:col-span-12"
            ...
            <form id="complaintForm" action='{{ route('add.complaint') }}' method="post" enctype="multipart/form-data">
                <div class='grid-cols-12 grid'>
                    ...
                    <div class='col-span-6 mr-5'>
                        <div class="input-form mt-3">
                            ...
                            <select formcontrolname="state" name="_customer_details_id" id="_customer_details_id"
                                ...
                                {{-- @php
                                    $query = DB::table('amc_visit.customerid')->join('customer_details.location_type');
                                @endphp --}}
                    ...
                    <div class='col-span-6 mr-5'>
                        <div class="input-form mt-3">
                            ...
                            <input type="text" id="amc_type" name="amc_type" value="" class="form-control"
                                required readonly>
                        </div>
                    </div>
                    ...
                    <div class="col-span-6 mt-3 mr-5">
                        ...
                        <input name="contact_p_name" type="text" placeholder="Contact Person Name"
                            class="form-control" />
                    </div>
                    <div class="col-span-6 mt-3 mr-5">
                        <label style="font-weight:600; line-height:30px;"> Contact Person Mobile No</label>
                        <input name="contact_p_mobile_no" type="text" placeholder="Contact Person Mobile No"
                    ...
                    <div class='col-span-12 mr-5'>
                        <div class="input-form mt-3">
                            <label style="font-weight:600; line-height:30px;"> Image (Optional)</label>
                    ...
                    <div class='col-span-12 mr-5'>
                        <div class="input-form mt-3">
                            <label style="font-weight:600; line-height:30px;"> Remark (Optional) </label>
                ...
                $('#complaintForm').validate({
                    rules: {
                        ...
                        mobile: {
                            ...
                            minlength: 10,
                            maxlength: 10,
                            number: true, // assuming mobile number is numeric
                        },
                        _customer_details_id: {
                            required: true,
                        },
                        amc_type: {
                            required: true,
                        ...
                        image: {
                            required: false,
                            // Add more rules if needed for file upload
                        },
                        item_description: {
                            required: true,
                        },
                    ...
                    messages: {
                        ref_no: "Please enter a complaint number",
                        _customer_id: "Please select a customer",
                        mobile: {
                        ...
                        _customer_details_id: "Please select an address",
                        amc_type: "Please enter an AMC type",
                        payment_type: "Please select a payment type",
                        priority: "Please select a priority",
                        job_category: "Please select a job category",
                        contact_p_name: "Please enter a contact person's name",
                        contact_p_mobile_no: {
                            required: "Please enter a contact person's mobile number",
                            minlength: "Mobile number must be at least 10 digits long",
                            maxlength: "Mobile number must not exceed 10 digits",
                            number: "Please enter a valid mobile number",
                        },
                        ...
                        item_description: "Please enter a description",
                    },
